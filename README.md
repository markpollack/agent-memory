...
Progressive memory management for [Spring AI](https://docs.spring.io/spring-ai/reference/).

[Documentation](https://lab.pollack.ai/projects/agent-memory) Gives AI agents the ability to manage conversational context intelligently — starting with proven context compaction, with a roadmap toward autonomous memory control.
...
Requires Java 17+. Uses Spring AI 2.0.0 GA.
